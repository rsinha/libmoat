...
int main(int argc, char *argv[])
{
  try {
    ...
    luciditee::Specification_OutputDescription *irene_output = spec->add_outputs();
    irene_output->set_output_name("irene_output");
    irene_output->set_type(luciditee::Specification_Type_FILE);
    luciditee::Specification_OutputDescription *sherlock_output = spec->add_outputs();
    sherlock_output->set_output_name("sherlock_output");
    sherlock_output->set_type(luciditee::Specification_Type_FILE);
