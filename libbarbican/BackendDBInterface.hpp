...
public:
  ...
  virtual bool  backend_db_destroy(int64_t fd, const char *name) = 0;
  ...
  virtual bool  backend_db_close(int64_t fd) = 0;
  virtual bool  backend_db_save(int64_t fd, const char* name) = 0;
  virtual bool  backend_db_load(int64_t fd, const char *db_path, const char *db_backup_path) = 0;
};
